...
public class Customer {
    ...
    /**
     * Constructor 2 (generates a Customer with random attributes, the input is the
     * seed)
     */
    public Customer(long seed) {
        ...
        if (p < 0.2)
            this.specialAssistence = true;
    }

    /**
     * Constructor 3 (generates a Customer with random attributes, the seed is
     * random as well)
     */
    public Customer() {
